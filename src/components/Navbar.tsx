...
const Navbar = ({ cartItemsCount, onCartOpen, onLoginOpen, searchQuery, onSearchChange }: NavbarProps) => {
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
      ...
      <div className="bg-black text-white py-1 sm:py-2 hidden md:block">
      ...
      <div className="container mx-auto px-4 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center md:mr-auto">
            <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-black whitespace-nowrap">
              <span className="md:hidden">WHOLESALE THREADS</span>
              <span className="hidden md:inline">WHOLESALE THREADS</span>
            </h1>
          </div>
